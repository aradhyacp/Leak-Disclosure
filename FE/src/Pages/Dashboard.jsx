...
const Dashboard = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <header
        className={`${isDark ? "bg-[#1a1a1a] border-[#2a2a2a]" : "bg-white border-gray-200"} shadow-sm border-b transition-colors duration-300`}
      >
      ...
      <div className="flex">
        {/* Modern Sidebar */}
        <aside
          className={`w-64 ${isDark ? "bg-[#1a1a1a] border-[#2a2a2a]" : "bg-white border-gray-200"} shadow-sm min-h-[calc(100vh-4rem)] border-r transition-colors duration-300`}
        >
          ...
          <div
            className={`px-4 mt-4 border-t ${isDark ? "border-[#2a2a2a]" : "border-gray-200"}`}
          >
          ...
          {userPlan === "free" && (
            <div
              className={`py-2 px-4 ${isDark ? "border-[#2a2a2a]" : "border-gray-200"}`}
            >
              <div
                className={`text-sm ${isDark ? "text-gray-400" : "text-gray-600"}`}
              >
                ...
                <div
                  className={`mt-2 w-full ${isDark ? "bg-[#2a2a2a]" : "bg-gray-200"} rounded-full h-2`}
                >
                  <div
