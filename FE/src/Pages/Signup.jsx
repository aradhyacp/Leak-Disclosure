...
const Signup = () => {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center ${isDark ? "bg-[#0a0a0a]" : "bg-gray-50"} transition-colors duration-300`}
    >
          ...
          appearance={{
            ...
            elements: {
              ...
              socialButtonsBlockButton: isDark
                ? "bg-[#2a2a2a] border-[#2a2a2a] text-white hover:bg-[#10b981] hover:border-[#10b981]"
                : "",
