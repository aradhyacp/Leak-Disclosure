...
const Upgrade = () => {
    ...
    const handleClick = async () => {
        ...
        const result = await fetch('http://localhost:3000/api/stripe/stripe-checkout',
            {
                headers: {
          ...
          <div className="bg-[url('/pricing-holder.jpg')] bg-cover h-[400px] rounded-xl p-5 flex flex-col justify-center mt-9">
            <div className="bg-[#ffffffd2] rounded-xl px-8 py-10">
              ...
              <div className="flex items-center mt-9 justify-evenly">
                ...
                <button className="bg-blue-700 px-22 py-3 rounded-xl text-white w-fit cursor-pointer hover:bg-blue-600" onClick={handleClick}>
                  Buy Now
                </button>
              </div>
            </div>
