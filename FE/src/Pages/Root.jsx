...
const Root = () => {
  ...
  const heroParallax = useSpring({
    ...
    opacity: scrollY.to([0, 500], [1, 0]),
  });

  // Parallax for features section
  const featuresParallax = useSpring({
    transform: scrollY.to((y) => {
      const windowHeight = window.innerHeight;
      const featuresOffset = windowHeight * 1.2; // Start parallax after hero
      if (y > featuresOffset) {
        return `translateY(${(y - featuresOffset) * 0.3}px)`;
      }
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#10b981] opacity-10 rounded-full blur-3xl animate-pulse"
        ...
        <div className="relative z-50 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-4 max-w-3xl mx-auto">
              Protect your digital identity. Check if your email has been
              compromised in data breaches.
            </p>
            <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
              Get instant alerts when your email appears in new breaches.
              Monitor multiple accounts and stay one step ahead of cyber
              threats.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="p-6 bg-[#1a1a1a] rounded-lg border border-[#2a2a2a] hover:border-[#10b981] transition-all">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              ...
              } transition-all hover:border-[#10b981] hover:shadow-lg hover:shadow-[#10b981]/20 hover:scale-105`}
            >
              ...
              <p className={isDark ? "text-gray-400" : "text-gray-600"}>
                Quickly check if your email has been exposed in any known data
                breaches. Get results in seconds.
              </p>
            </div>
            ...
            >
              ...
              <p className={isDark ? "text-gray-400" : "text-gray-600"}>
                Get comprehensive breach details including severity, industry,
                and timeline. Understand your risk profile.
              </p>
            </div>
            ...
            >
              ...
              <p className={isDark ? "text-gray-400" : "text-gray-600"}>
                Monitor multiple email addresses and receive instant
                notifications when new breaches are detected.
              </p>
            </div>
          </div>
        </div>
